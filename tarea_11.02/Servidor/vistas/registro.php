...
<body>
    <div class="contenedor-principal-login">
        <a id="volver-atras" href="index.php?c=Cusuario&m=mostrarAcceso"> ⬅ Volver</a>

        <form id="formRegistro" class="formulario-base" action="index.php?c=Cusuario&m=registrar" method="post">
            <h2>Crear Cuenta</h2>
            ...
            <p class="texto-ayuda">
                ¿Ya tienes cuenta?
                <a href="index.php?c=Cusuario&m=mostrarLogin">Inicia sesión</a>
            </p>
        </form>
    </div>
</body>
